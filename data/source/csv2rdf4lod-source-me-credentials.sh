...
source /etc/prizms/lofd/triple-store/virtuoso/csv2rdf4lod-source-me-for-virtuoso-credentials.sh
source /etc/prizms/lofd/ckan/datahub.io/csv2rdf4lod-source-me-for-ckan-credentials.sh

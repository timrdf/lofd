...
export CSV2RDF4LOD_PUBLISH_DATAHUB_METADATA_OUR_BUBBLE_ID="lofd"
...
export CSV2RDF4LOD_PUBLISH_VC_REPOSITORY="git@github.com:timrdf/lofd.git"
export DATAFAQS_BASE_URI="http://lofd.tw.rpi.edu"
